...
func (r *fakeKBRepo) GetKnowledgeBaseByName(_ context.Context, _ uint64, _ string) (*types.KnowledgeBase, error) {
	return nil, nil
}
...
func (r *fakeKBRepo) ListKnowledgeBasesByParentID(_ context.Context, _ uint64, _ string) ([]*types.KnowledgeBase, error) {
	return nil, nil
}
