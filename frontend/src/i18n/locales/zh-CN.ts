export default {
  ...
  questionBank: {
    title: "题集",
    createSet: "创建题集",
    searchSetPlaceholder: "搜索题集",
    setListName: "名字",
    setListCount: "数量",
    setListOperation: "操作",
    noMatchingSet: "未找到匹配的题集",
    noSet: "暂无题集",
    noSetDescription: "暂无题集，请先创建题集或导入题目",
    renameSet: "重命名",
    renameSetTitle: "重命名题集",
    setName: "题集名称",
    setNamePlaceholder: "请输入题集名称",
    name: "题库名称",
    description: "描述",
    ...
    importConfirm: "导入",
    importMethod: "导入方式",
    pasteMode: "粘贴 JSON / JSONL",
    fileMode: "上传文件",
    pasteJsonl: "粘贴 JSON 或 JSONL 数据",
    jsonPlaceholder: "支持 JSON 对象、JSON 数组或 JSONL，每行一个 JSON 对象",
    formatHelp: "支持题库格式 stem_text/answer_text，也支持评测集格式 question/reference_answer。",
    fileUploadHint: "拖拽或选择 .json / .jsonl 文件，文件仅在本地解析",
    selectFile: "选择文件",
    parsedCount: "解析成功 {count} 题",
    duplicateCount: "疑似重复 {count} 题",
    importCount: "将导入 {count} 题",
    parseErrorCount: "解析错误 {count} 条",
    allowDuplicates: "允许重复导入",
    duplicateHelp: "默认跳过重复题；勾选允许重复导入后可导入。",
    parseErrors: "解析错误：",
    importWarnings: "导入提示：",
    jsonImport: "JSON / JSONL 导入",
    jsonImportDescription: "上传或粘贴结构化题目数据",
    wordImport: "Word / DOCX 导入",
    wordImportDescription: "从 Word 试卷中识别题目",
    pdfImport: "PDF 导入",
    pdfImportDescription: "从 PDF 试卷中识别题目",
    comingSoon: "即将支持",
    generateTitle: "生成题目",
    generateConfig: "生成配置 (JSON)",
    export: "导出评测集",
    type: "类型",
    typeFilter: "题型",
    stem: "题干",
    stemPlaceholder: "请输入题干",
    difficulty: "难度",
    difficultyFilter: "难度",
    easy: "简单",
    medium: "中等",
    ...
    analysis: "解析",
    analysisPlaceholder: "可选解析",
    questionBody: "题目结构 (JSON)",
    answerBody: "答案结构 (JSON)",
    // File import
    fileImportTitle: "{type} 导入题目",
    fileImportWord: "Word / DOCX 导入",
    fileImportPdf: "PDF 导入",
    wordImportDescription: "从 Word 文档中识别题目结构",
    pdfImportDescription: "从 PDF 文件中识别题目结构",
    fileImportSelect: "选择文件",
    fileImportSelected: "已选择：{name}（{size}）",
    fileImportParsePreview: "解析预览",
    fileImportParsing: "解析中...",
    fileImportDetected: "识别题目数",
    fileImportWithAnswer: "有答案",
    fileImportWithoutAnswer: "缺答案",
    fileImportPreviewList: "题目预览列表",
    fileImportNoQuestions: "未识别到题目",
    fileImportRawText: "原始文本预览",
    fileImportEdit: "编辑",
    fileImportDelete: "移除",
    fileImportConfirm: "确认导入",
    fileImportImportMode: "导入方式",
    fileImportModeDraft: "导入为草稿（默认）",
    fileImportModeReviewed: "确认无误，导入为已审",
    fileImportModeDraftHelp: "文档识别可能存在误拆题、漏答案，推荐先以草稿导入后人工复核。",
    fileImportEmptyAnswer: "缺答案",
    fileImportDefaultDifficulty: "默认难度",
    fileImportDefaultDifficultyHint: "仅作为导入时的默认值。当前暂不自动识别原文中的难度。",
    fileImportError: "错误",
  ...
  agentEditor: {
    ...
    tools: {
      ...
      questionBankSearch: "题库搜索",
      questionBankSearchDesc: "在题库知识库中按关键词检索题目，匹配题干、答案、解析、知识点和标签",
      requiresKb: "（需要配置知识库）",
