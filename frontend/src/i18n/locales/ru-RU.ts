...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    tools: {
      ...
      questionBankSearch: 'Поиск по банку вопросов',
      questionBankSearchDesc: 'Поиск вопросов в банке вопросов по ключевым словам в стемах, ответах, анализе, точках знаний и тегах',
      ...
      needsQuestionBank: '(требуется банк вопросов)',
      // Wiki чтение
